  ...
  <div class="row">
        ...
        <div class="card-header">
          <div class="row align-items-center">
            ...
            <div class="col-4 text-right">
              <a href="" onclick="event.preventDefault()" class="btn btn-sm btn-primary send"><i class="fas fa-save"></i>
                Save</a>
            </div>
          </div>
        </div>
          ...
          <form class="form" action="{{ route('admin.book.store') }}" method="POST"
            ...
            <div class="form-group">
                  ...
                  <div class="custom-file">
                    <input onchange="document.getElementById('cover_preview').src = window.URL.createObjectURL(this.files[0])"
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <img style="object-fit: cover" id="cover_preview" class="img-fluid" width="330px" height="400px" src="{{ asset('storage/backend/placeholder-image/book.png') }}" alt="">
        </div>
      </div>
    </div>
  </div>
